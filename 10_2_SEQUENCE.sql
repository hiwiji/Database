...
START WITH 223  -- 223번부터 시작
INCREMENT BY 10 -- 10씩 증가
NOCYCLE         -- 반복 X (기본값)
NOCACHE;        -- 캐시 X (캐시 20 기본값)
...
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '이길동'); -- 244 / 이길동
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '박길동'); -- 245 / 박길동
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '최길동'); -- 246 / 최길동
SELECT * FROM EMP_TEMP;
